 ...
 %>
    ...
    <div class="wrapper">
      ...
      <div class="main-panel">
                      ...
                      <thead>
                        ...
                        <%
                           ...
                           Connection con = DBConnection.getConnection();
                               ...
                               ResultSet rs = st.executeQuery("SELECT * FROM regteacher");
                          ...
                          <tr>
                           ...
                           <td><%=rs.getString("name")%></td>
                            ...
                            <td>
                              ...
                              <form action="${pageContext.request.contextPath}/ApproveFacServlet" method="post" id="approveForm_<%=rs.getInt("faculty_id")%>">
            <input type="hidden" name="facid" value="<%=rs.getInt("faculty_id")%>">
        </form>
                                ...
                                onclick="document.getElementById('approveForm_<%=rs.getInt("faculty_id")%>').submit();"
                                >
        ...
        <form action="${pageContext.request.contextPath}/RejectFacServlet" method="post" id="rejectForm_<%=rs.getInt("faculty_id")%>">
            <input type="hidden" name="facid" value="<%=rs.getInt("faculty_id")%>">
              </form>
                                ...
                                <button
                                 ...
                                 onclick="document.getElementById('rejectForm_<%=rs.getInt("faculty_id")%>').submit();"
                                >

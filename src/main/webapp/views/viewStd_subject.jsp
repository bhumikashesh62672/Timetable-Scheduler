        ...
        <div class="container">
          <div class="page-inner">
           <div class="page-header">
              <h3 class="fw-bold mb-3">Show Subjects...</h3>
                      ...
                      >
                        ...
                        <tbody>
                                 ...
                                 Connection con = DBConnection.getConnection();
                                     ...
                                     ResultSet rs = st.executeQuery("SELECT * FROM subjects where dept_id="+d_id+" and sem='"+sem+"';");
...
try {
         ...
         PreparedStatement ps2 = con.prepareStatement("SELECT username FROM login_teacher where fac_id="+fid+";");
...
<%
      ...
      try {
         ...
         PreparedStatement ps = con.prepareStatement("SELECT dept_name FROM departments where dept_id="+d_id+";");
...
%>
                              ...
                              <form action="${pageContext.request.contextPath}/views/edit_subject.jsp" method="post" id="editSForm_<%=rs.getInt("sub_id")%>">
            <input type="hidden" name="sub_id" value="<%--rs.getInt("sub_id")--%>">
                                ...
                                onclick="document.getElementById('editSForm_<%--rs.getInt("sub_id")--%>').submit();"
                                >
                                  <i class="fa fa-edit"></i>
                                </button>
                                
       <form action="${pageContext.request.contextPath}/DeleteSubjectServlet" method="get" id="deleteSForm_<%--rs.getInt("sub_id")--%>">
            <input type="hidden" name="sub_id" value="<%--rs.getInt("sub_id")--%>">
                      ...
                      <%
    String msg = (String)request.getAttribute("editmsg2");
    if(msg != null){
%>
<script>alert("<%=msg%>");</script>
<%
    }
    String msg2 = (String)request.getAttribute("addS");
    if(msg2 != null){
%>
<script>alert("<%=msg2%>");</script>
<%
    }
    String msg3 = (String)request.getAttribute("delmsg1");
    if(msg3 != null){
%>

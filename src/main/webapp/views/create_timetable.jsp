...
<html lang="en">
 ...
 %>
     ...
     <div class="container">
          <div class="page-inner">
            <div class="page-header">
              <h3 class="fw-bold mb-3">Create Timetable...</h3>
              <ul class="breadcrumbs mb-3">
                ...
                <li class="nav-item">
                  <a href="${pageContext.request.contextPath}/views/create_timetable.jsp">create timetable</a>
                </li>
               <!--   <li class="separator">
                  <i class="icon-arrow-right"></i>
                </li>
    ...
    try {
         ...
         PreparedStatement ps1 = con.prepareStatement("SELECT * FROM departments");
...
%>
    ...
    try {
         ...
         PreparedStatement ps2 = con.prepareStatement("SELECT * FROM subjects");
...
<%
    ...
    try {
         ...
         PreparedStatement ps1 = con.prepareStatement("SELECT * FROM departments where dept_id="+ rs2.getString("dept_id") +";");
        ResultSet rs1 = ps1.executeQuery();
...
%> 
    ...
    try {
         ...
         PreparedStatement ps3 = con.prepareStatement("SELECT * FROM rooms");
...
%>          
          ...
          <div class="page-inner">
                ...
                <div class="card">
                 ...
                 PreparedStatement ps1 = con1.prepareStatement("SELECT * FROM departments where dept_id="+d_id+";");
                  ResultSet rs1 = ps1.executeQuery();
                 ...
                 while(rs1.next()) {
                          ...
                          <tr>
                            ...
                            <td><%=rs.getString("day")%></td>
                                         <% PreparedStatement ps4 = con1.prepareStatement("SELECT * FROM rooms where room_id="+r_id+";");
                  ResultSet rs4 = ps4.executeQuery();

                 while(rs4.next()) {
        	                   %>
                            <td> <%=rs.getString("time_slot")%> / <%= rs4.getString("room_num") %>-<%= rs4.getString("room_name") %>
        	                   
                            </td>
                               <%}
                            
                                 PreparedStatement ps2 = con1.prepareStatement("SELECT * FROM subjects where sub_abbr= '"+s_abbr+"' and dept_id="+d_id+";");
                  ResultSet rs2 = ps2.executeQuery();
                 ...
                 PreparedStatement ps3 = con1.prepareStatement("SELECT * FROM login_teacher where fac_id="+f_id+";");
                  ResultSet rs3 = ps3.executeQuery();
            ...
            <%} %>
                              ...
                              <form action="${pageContext.request.contextPath}/views/edit_timetable.jsp" method="post" id="editTForm_<%=rs.getInt("tt_id")%>">
            <input type="hidden" name="tt_id" value="<%=rs.getInt("tt_id")%>">
                                ...
                                onclick="document.getElementById('editTForm_<%=rs.getInt("tt_id")%>').submit();"
                                >
                                  <i class="fa fa-edit"></i>
                                </button>
                                
       <form action="${pageContext.request.contextPath}/DeleteTimetableServlet" method="get" id="deleteTForm_<%=rs.getInt("tt_id")%>">
            <input type="hidden" name="tt_id" value="<%=rs.getInt("tt_id")%>">
                                ...
                                <button
                                 ...
                                 onclick="document.getElementById('deleteTForm_<%=rs.getInt("tt_id")%>').submit();"
                                >
...
%>
                ...
                <div>
                  <div style="align:center; margin-left: 35%">
                      <button class="btn btn-success" formaction="${pageContext.request.contextPath}/">
                      ...
                      <button class="btn btn-danger" formaction="${pageContext.request.contextPath}/">
                        <span class="btn-label">

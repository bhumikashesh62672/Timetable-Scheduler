...
<html lang="en">
  ...
  <meta charset="UTF-8">
    ...
    <title>Registered Faculty Data</title>
    <meta
        ...
        <div class="container">
          <div class="page-inner">
            <div class="page-header">
              <h3 class="fw-bold mb-3">Registered Faculty List...</h3>
              <ul class="breadcrumbs mb-3">
                ...
                <li class="nav-item">
                  <a href="${pageContext.request.contextPath}/views/registeredFaculty.jsp">Registered Faculty</a>
                </li>
              </ul>
            </div>
              ...
              <div class="col-md-12">
                <div class="card">
                  <div class="card-header">
                    <h4 class="card-title">Registered Faculty</h4>
                  </div>
                  <div class="card-body">

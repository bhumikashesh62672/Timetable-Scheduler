     ...
     <div class="container">
              ...
              <div class="col-md-12">
                <div class="card">
                  <div class="card-header">
                    <div class="card-title">Add Rooms</div>
                  </div>
                   ...
                   <form action="${pageContext.request.contextPath}/RoomServlet" method="post">
                         ...
                         <div class="form-group">
                          <label for="largeInput">Enter Room Number</label>
                          <input
                            type="text"
                        ...
                        <div class="form-group">
                          <label for="largeInput">Enter Room's Identity Name</label>
                          <input
                            type="text"
                            class="form-control form-control-lg"
                            id="largeInput"
                            NAME="room_name"
                            placeholder="e.g. classroom or lab "
                            required="required"
                          />
                        </div>
          ...
          <div class="page-inner">
            ...
            <input type="hidden" name="room_id" value="<%=rs.getInt("room_id")%>">
                                ...
                                onclick="document.getElementById('editForm_<%=rs.getInt("room_id")%>').submit();"
                                >
                                  <i class="fa fa-edit"></i>
                                </button>
                                
       <form action="${pageContext.request.contextPath}/RoomServlet" method="get" id="deleteForm_<%=rs.getInt("room_id")%>">
            <input type="hidden" name="room_id" value="<%=rs.getInt("room_id")%>">
            <input type="hidden" name="action" value="delete">
                      ...
                      <%
    String msg = (String)request.getAttribute("editmsg1");
    if(msg != null){
%>
